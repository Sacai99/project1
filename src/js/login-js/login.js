$(function() {
    ...
    function formType(i) {
        if (i == 0) {
            ...
            $("form button.voice-btn").attr("data-btn", "sms-voice-btn").text("");
    ...
    Focuss($(".msgInput"), "请输入验证码");
    Focuss($(".phoneInput"), "请输入手机号");
    Focuss($(".accountUsername"), "会员名/邮箱/手机号");
    Focuss($(".accountPwd"), "请输入登录密码");

    Blurr($(".phoneInput"), "请输入手机号");
    Blurr($(".msgInput"), "请输入验证码");
    Blurr($(".accountUsername"), "会员名/邮箱/手机号");
    Blurr($(".accountPwd"), "请输入登录密码");
